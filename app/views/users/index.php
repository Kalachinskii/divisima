            ...
            <div class="row">
                <div class="row table-responsive ">
                    <ol class="list-group list-group-numbered">
                        <li class="mb-1 mt-1 list-group-item d-flex justify-content-between align-items-start">
                            <div class="ms-2 me-auto">
                                <div class="fw-bold">Qwer1234</div>
                            </div>
                        ...
                        <li class="mb-1 mt-1 list-group-item d-flex justify-content-between align-items-start">
                            ...
                            <button type="button" class="btn btn-primary mr-3" data-bs-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">
                                <i class="fa-solid fa-basket-shopping">
                                    Корзина
                                </i>
                                <span class="badge bg-secondary">4</span>
